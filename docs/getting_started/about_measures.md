...
Measures can be downloaded directly from BCL through the [OpenStudio Application](../tutorials/creating_your_model/#using-the-measures-tab) and [PAT](../reference/parametric_studies/#downloading-measures-from-the-building-component-library) as well.
