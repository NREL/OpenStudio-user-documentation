...
Measures can be downloaded directly from BCL through the [OpenStudio Application](../tutorials/creating_your_model/#downloading-components-and-measures-from-the-building-component-library-bcl) and [PAT](../reference/parametric_studies/#downloading-measures-from-the-building-component-library) as well.
